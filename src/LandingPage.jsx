    ...
    <div className="font-sans bg-[#08081b] text-gray-100 min-h-screen">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mt-6 md:mx-24 grid grid-cols-1 md:grid-cols-2 gap-4 gap-x-12">
              ...
              <input
                ...
                onChange={handleChange}
                className="p-3 rounded-md bg-gray-700/40 text-white w-full border border-sky-500/90"
              />
              ...
              >
                ...
                <option value="0 - 6 months" className="text-black">
                  0 - 6 months
                </option>
                <option value="6 months - 1 year" className="text-black">
                  6 months - 1 year
                </option>
                ...
                <option value="Above 5 years" className="text-black">
                  Above 5 years
                </option>
              </select>
            </div>
            <button
              type="submit"
              className="mt-6 bg-yellow-500 text-black px-6 py-3 rounded-md font-bold hover:bg-yellow-600"
            >
              Book an Appointment
            </button>
          </form>
        ...
        >
          <div className="flex flex-col md:flex-row items-center md:justify-between">
            <div className="text-center md:text-left md:w-2/3">
              <h2 className="text-2xl md:text-5xl md:ml-24 font-bold">
                By Dr.CN Sai Vigneshvar
              </h2>
            ...
            <img
              ...
              className="w-48 z-20 h-48 md:w-96 md:-mt-44 -mb-6 md:h-96 object-cover object-top "
            />
          </div>
        </motion.div>
      ...
      <section className="py-24 bg-[#08081b]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl mt-6 font-normal w-96 justify-self-center">
              An easy and effective approach designed for your everyday life
              that helps you
            </p>
          </motion.h2>
            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -10 }}
                  className="bg-[#1a1ac1] border border-white/50 p-8 rounded-2xl flex gap-6 shadow-xl "
                >
      ...
      <div className="flex justify-center">
        <motion.button
          whileHover={{
            scale: 1.05,
            boxShadow: "0 10px 25px -5px rgba(156, 241, 99, 0.08)",
          }}
          whileTap={{ scale: 0.95 }}
      ...
      <section className="py-24 bg-[#08081b]">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          >
            ...
            <h3 className="text-3xl md:text-6xl font-semibold text-white mb-16">
              I Want to Ask You a{" "}
              <p className=" text-transparent bg-clip-text bg-yellow-500">
                {" "}
                Few Questions{" "}
              </p>
            </h3>
          ...
          >
            <h2 className="text-4xl md:text-5xl md:max-w-3/4 justify-self-center font-semibold text-center text-white mb-20">
              <p className="text-white mb-2">
                {" "}
                What <span className="text-yellow-500"> Will Change </span>{" "}
                After
              </p>{" "}
              You Start with Us?
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-center text-white mb-16">
              Who Is <span className="text-yellow-500"> This For? </span>{" "}
            </h2>
              ...
              <div>
                <ul className="space-y-6 md:ml-32">
                  {[
                    [
                      "Have ",
                      <span className="text-yellow-500 font-semibold" key="1">
                    ...
                    [
                      ...
                      <span className="text-yellow-500 font-semibold" key="2">
                        HbA1c
                      </span>,
                    ...
                    [
                      ...
                      <span className="text-yellow-500 font-semibold" key="3">
                        tired
                      </span>,
                    ...
                    [
                      "Want to take ",
                      <span className="text-yellow-500 font-semibold" key="4">
              ...
              <div>
                <ul className="space-y-6 md:ml-32">
                  {[
                    ...
                    <li key={index} className="flex items-start">
                      <svg
                        className="w-6 h-6 text-red-500 mr-4 mt-1 flex-shrink-0"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2 ">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Meet your <span className="text-yellow-400">Doctor</span>
            </h2>
            <p className="text-lg mb-4 text-justify">
              I'm Dr. Sai Vigneshvar, your dedicated diabetes specialist, here
              to guide you toward better health and well-being. Whether you're
              newly diagnosed with diabetes, managing it for years, or just
              looking for ways to improve your blood sugar control, I specialize
              in helping people like you regain control over their health and
              live a life free from diabetes-related worries.
            </p>
            <p className="text-lg mb-4 text-justify">
              With a Simple Diabetes Care Plan, I empower you to unlock your
              full health potential. Imagine transforming your daily routine
              into a series of small, manageable steps that lead to better blood
              sugar levels, increased energy, and a healthier lifestyle. All
              while making sustainable changes that fit easily into your busy
              life.
            </p>
            <p className="text-lg mb-4 text-justify">
              Together, we'll rewrite your health story. Join me on this
              transformative journey and let's create a path to healthier
              living, free from the fear and complications of diabetes.
            </p>
            <button
              onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
        ...
        <div className="max-w-3xl mx-5 md:absolute -mb-64 right-44 -translate-y-44 bg-white text-black rounded-lg p-6 mt-8 shadow-lg flex flex-col space-y-4">
          <ul className="space-y-3 text-lg">
            <li className="flex items-center gap-3">
              ...
              <span>
                <strong>5+ Years of Experience</strong> in treating diabetes
              </span>
            </li>
            <li className="flex items-center gap-3">
              <span className="text-black font-bold">•</span>{" "}
              <span>
                <strong>10,000+ patients</strong> treated with a focus on
                holistic care
              </span>
            </li>
            <li className="flex items-center gap-3">
              <span className="text-black font-bold">•</span>{" "}
              <span>
                <strong>Proven track record</strong> in reducing HbA1c and
            ...
            <li className="flex items-center gap-3">
              <span className="text-black font-bold">•</span>{" "}
              <span>
                <strong>Personalized treatment</strong> tailored to your
      ...
      <div className="bg-[#08081b] border-t-4 py-4 text-center mt-10">
        <Link
          to="/privacy-policy"
            ...
            >
              <div className="flex-1 flex flex-col justify-center">
                <p className="text-white text-lg md:text-xl mb-6 italic relative">
                  <span className="absolute top-0 left-0 text-5xl text-yellow-400 opacity-20">
                    "
                  </span>
                  {testimonial.content}
                  <span className="absolute bottom-0 right-0 text-5xl text-yellow-400 opacity-20">
                    "
                  </span>
                </p>
                <div className="mt-6">
